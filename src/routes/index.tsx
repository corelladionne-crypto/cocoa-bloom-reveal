  ...
  return (
    <section className="relative h-full w-full overflow-hidden bg-kraft">
      ...
      <div className="relative flex h-full flex-col items-center justify-start px-6 pt-10 text-center">
        ...
        <img src={cocoaPodMockup} alt="Cocoa pod packaging artwork" className="w-[26rem] max-w-none shrink-0 origin-top scale-[1.7] object-contain drop-shadow-[0_18px_35px_rgba(61,38,20,.25)]" />
      </div>
